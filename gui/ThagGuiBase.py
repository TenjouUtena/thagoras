...
###########################################################################
## Class ThagWorldDialog
###########################################################################

class ThagWorldDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		fgSizer1.Add( self.world_name, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.world_address, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.world_port, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.world_font, 0, wx.ALL, 5 )
		
		
		bSizer3.Add( fgSizer1, 2, wx.EXPAND, 2 )
		...
		bSizer3.Add( m_sdbSizer1, 1, wx.EXPAND|wx.FIXED_MINSIZE, 1 )
